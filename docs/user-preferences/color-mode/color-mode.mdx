...
<details>
  ...
  <ul>
    <li><strong>Windows</strong>: Open Settings > Personalization > Colors, then pick a pre-existing theme in <em>Choose your mode</em> option.</li>
    <li><strong>macOS</strong>: Open System Preferences > General, and select the theme.</li>
    <li><strong>iOS</strong>: Open Settings > Display & Brightness, then tap the theme.</li>
    <li><strong>Android</strong>: Open Settings > Display, then choose the color scheme.</li>
  </ul>
