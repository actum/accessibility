...
<details>
  ...
  <ul>
    <li>Light mode</li>
    <li>Dark mode</li>
    <li>Synchronize color mode with operating system mode</li>
  </ul>

  Setting either light or dark mode will switch the page to the respective theme mode. Setting the synchronize with operating system will set the same theme users have chosen in their operating system theme settings.
