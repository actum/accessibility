...
Learn about these user preferences, how to support them with some implementation tips, and what it could mean for users if they are not respected.
...
- [Forced colors](/docs/user-preferences/forced-colors)
- [Reduced motion](/docs/user-preferences/reduced-motion)
