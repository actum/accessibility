...
When the sequence in which content is presented affects its meaning, a correct reading sequence can be [programmatically determined](/docs/wcag-documents/glossary-of-terms#programmatically-determined).
