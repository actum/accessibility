...
<iframe width="560" height="315" src="https://www.youtube.com/embed/RWSKQPlckrk" title="1.3.2 - Meaningful Sequence - WCAG Documents" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
...
<img src="/img/1.3.2-meaningful-sequence.png" srcSet="/img/1.3.2-meaningful-sequence.png 1x, /img/1.3.2-meaningful-sequence-2x.png 2x" alt="" width="400" height="286" style={{aspectRatio: '400/286' }} />
...
<details>
	<summary>
    <span>If a webpage has a Q&A section, is it important for the answer to immediately follow its corresponding question?</span>
  </summary>
...
<details>
	<summary>
    <span>Is meaningful sequence only important for text-based content?</span>
  </summary>
...
<details>
	<summary>
    <span>It is a good practice to use positive numbers for <code>tabindex</code> for better focus order management. True or false?</span>
  </summary>
