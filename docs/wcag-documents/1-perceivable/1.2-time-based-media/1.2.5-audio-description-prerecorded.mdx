...
- [1.2.8 - Media Alternative (Prerecorded) - AAA](./1.2.8-media-alternative-prerecorded.mdx) - you must include both **transcript** AND **audio description** to comply with the criterion.
