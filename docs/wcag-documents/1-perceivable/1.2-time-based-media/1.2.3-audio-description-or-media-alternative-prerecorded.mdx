...
<details>
	<summary>
    <span>Are audio descriptions required for the alternate presentation of information already available in text on the page?</span>
  </summary>
...
<details>
	<summary>
    <span>If there is only an audio description provided for the synchronized media without a transcript, would that conform to this WCAG criterion?</span>
  </summary>
