...
<img src="/img/1.4.1-example-table-correct.jpg" srcSet="/img/1.4.1-example-table-correct.jpg 1x, /img/1.4.1-example-table-correct-2x.jpg 2x" alt="A table showing availability of courts for different times. Table cells that represent free slots have green background and text 'FREE'. These that represent reserved slots have red background and text 'RESERVED'." width="600" height="411" style={{aspectRatio: '600/411' }} />
...
<img src="/img/1.4.1-example-pie-incorrect.jpg" srcSet="/img/1.4.1-example-pie-incorrect.jpg 1x, /img/1.4.1-example-pie-incorrect-2x.jpg 2x" alt="A pie chart divided into 3 parts that differ only by color. Below is a legend connecting labels to colors: Red for Operations, green for Marketing, and blue for Sales" width="600" height="500" style={{aspectRatio: '600/500' }} />

#### Example 2: Reservation System

Online reservation system has a table showing availability of sport courts for different times. Table cells differ only by color. Below is a legend connecting labels to colors: Green for Free, and red for Reserved. This mirrors the same accessibility concern as the previous example because the information depends solely on color.

<img src="/img/1.4.1-example-table-incorrect.jpg" srcSet="/img/1.4.1-example-table-incorrect.jpg 1x, /img/1.4.1-example-table-incorrect-2x.jpg 2x" alt="A table showing availability of courts for different times. Below is a legend connecting labels to colors: Green for Free, and red for Reserved" width="600" height="485" style={{aspectRatio: '600/485' }} />
...
<details>
   ...
   It is enough to meet WCAG conformance but is not a great user experience. Not relying only on color and providing more visual clues, such as underlined styles for links, would enhance the experience for many users.
</details>
