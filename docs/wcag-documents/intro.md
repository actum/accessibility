...
**Success criteria** are what determine conformance to WCAG which means in order to meet WCAG, the content needs to meet the success criteria. They describe how to make web content more accessible.
